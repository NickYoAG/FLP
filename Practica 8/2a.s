...
[ a<=x ] whileTrue: [ 
	((self primo:a)==1)ifTrue:[
			...
			((temp == (self voltear:temp2)) & ((temp~=21) & (temp~=12))) ifTrue: [ "Profe, aqui no considero el 37 porque obviamente si cumpliria, por eso no considero su posicion de primo que es 12"
